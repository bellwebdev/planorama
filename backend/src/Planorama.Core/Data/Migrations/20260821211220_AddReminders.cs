        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HangfireJobId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reminders_ItineraryItems_ItineraryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reminders_ItineraryItemId",
                table: "Reminders",
